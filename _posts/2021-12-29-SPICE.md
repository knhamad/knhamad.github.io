...
## Method: SPICE
To put it in the most simple manner, take the figure below as an example for how the LMM equation works. This is a one-dimensional example. The endmembers are already defined and substituting the values into LMM using data point 1.5 follows:

*p*<sub>1</sub>&times;1+*p*<sub>2</sub>&times;3=1.5
...
This constraint will make sure that the data is inside the region that the endmembers cover. Now the system can be solved using this constraint. 

*p*<sub>1</sub>&times;1+*p*<sub>2</sub>&times;3=1.5
*p*<sub>1</sub>&times;+*p*<sub>2</sub>=1
