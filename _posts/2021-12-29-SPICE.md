...
which violates the constraint that the proportion values must be &ge;0 and would produce an error. This is how the constraint is making the data inside the region that the endmembers cover.
