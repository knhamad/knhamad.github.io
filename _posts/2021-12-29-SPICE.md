...
**X**<sub>*i*</sub> is the observed pixel, *p*<sub>*ik*</sub> is the proportion of endmember *k* in pixel *i*, **E**<sub>*k*</sub> is the k<sup>th</sup> endmember, and *&epsilon;*<sub>*i*</sub> is an error term. The LMM assumes that each of the 3 materials, from the previous example, has its own endmember and a proportion value in every pixel and combing them produces the seen spectrum. The figure below illustrates this process for a single pixel captured by HSC.
